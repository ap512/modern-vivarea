...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote-lite.css">
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href="{{url('/admin/home')}}"><span>Add Home Feature</span></a>
               @else
               <a href="{{url('/admin/home')}}"><span>Update Home Feature</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add Home Feature</h4>
          @else
            <h4 class="mb-4">Update Home Feature</h4>
            @endif
         </div>
         <form action="{{url('admin/store_add_home_feature_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
                        ...
                        <div class="details_inner">
                           <div class="part">
                              <div class="row">
                                 ...
                                 <div class="col-lg-10 data">
                                      <textarea type="text" placeholder="Enter Features" name="features[]"></textarea>   
                        ...
                        <div class="details_inner">
                           <div class="part">
                              <div class="row">
                                 ...
                                 <div class="col-lg-10 data">
                                      <textarea type="text" placeholder="Enter Features" name="features[]">{{$f->description}}</textarea>   
                                       @if($errors->has('features')) <p class="error_mes">{{ $errors->first('features') }}</p> @endif
                                 </div>
                              </div>   
                           </div>

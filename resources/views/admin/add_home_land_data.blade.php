...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote-lite.css">
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add Home Land</span></a>
               @else
               <a href=""><span>Update Home Land</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add Home Land</h4>
          @else
            <h4 class="mb-4">Update Home Land</h4>
            @endif
         </div>
         <form action="{{url('admin/store_add_home_land_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf

      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            ...
            <div class="btn1-main">
                ...
                <button class="btn1"><a href="{{url('admin/add_home_feature_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped">
               ...
               @foreach($home_feature as $key=>$ad)
                 <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                       ...
                       <td>
                            <img src="/uploads/{{$ad->image}}" height="100px" width="100px">
                       </td> 

                       <td>{{$ad->title}}</td>

                        <td>
                          <a class="icon__1" href="{{url('admin/add_home_feature_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                           <a class="icon__2" onclick="delete_cs_banner_list({{$ad->id}})"><i class="fas fa-trash-alt"></i></a>

                        </td>
                        <td class="clo">
                           <button class="clo btn0"><a href="{{url('/admin/view_home_feature')}}/{{$ad->id}}">view</a></button>
                        </td>
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_home_feature/'+id,
                                            type:'GET',
                                            dataType: "json",

      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($home_gallery_description as $id)
                ...
                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/update_home_gallery_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            ...
            <div class="btn1-main">
                ...
                <button class="btn1"><a href="{{url('admin/add_home_gallery_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped">
               ...
               @foreach($home_gallery as $key=>$ad)
                 <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                        ...
                        <td>
                          <!-- <a class="icon__1" href="{{url('admin/add_home_gallery_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a> -->
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_home_gallery/'+id,
                                            type:'GET',
                                            dataType: "json",

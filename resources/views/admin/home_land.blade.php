...
@section('content')
  ...
  <div class="head-banner">
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Home Land</h4>

            
            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <button class="btn1"><a href="{{url('admin/add_home_land_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
               ...
               @foreach($home_land as $key=>$ad)
                <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                        ...
                        <td>
                            <a class="icon__1" href="{{url('admin/add_home_land_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_home_land/'+id,
                                            type:'GET',
                                            dataType: "json",

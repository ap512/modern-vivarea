...
@section('content')
  ...
  <div class="head-banner">
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Inquiry Details</h4>

            
            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <!-- <button class="btn1"><a href="{{url('admin/add_inquiry_data')}}/0" style="color:white;">ADD</a></button> -->
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive">
                 ...
                 <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                       ...
                       <td><?php echo date("j M , Y", strtotime($ad->date)) ?></td>
                        ...
                        <td>
                          <!-- <a class="icon__1" href="{{url('admin/add_inquiry_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a> -->
                           <a class="icon__2" onclick="delete_inquiry({{$ad->id}})"><i class="fas fa-trash-alt"></i></a>
            ...
            {{ $inquiry->links('admin.pagination') }}
         </div>
      </div>
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_inquiry/'+id,
                                            type:'GET',
                                            dataType: "json",

...
@section('content')
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Price Inquiry Detail</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Price Inquiry Details</h4>

            
            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <!-- <button class="btn1"><a href="{{url('admin/add_price_inquiry_data')}}/0" style="color:white;">ADD</a></button> -->
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped">
               ...
               @foreach($price_inquiry as $key=>$ad)
                 <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                       ...
                       <td><?php echo date("j M , Y", strtotime($ad->date)) ?></td>
                        ...
                        <td>
                          <!-- <a class="icon__1" href="{{url('admin/add_price_inquiry_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a> -->
                           <a class="icon__2" onclick="delete_price_inquiry({{$ad->id}})"><i class="fas fa-trash-alt"></i></a>
            ...
            {{ $price_inquiry->links('admin.pagination') }}
         </div>
      </div>
     ...
     <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
      ...
      <script type="text/javascript">
        ...
        $(function() {
               ...
               function delete_price_inquiry($id){
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_price_inquiry/'+id,
                                            type:'GET',
                                            dataType: "json",
